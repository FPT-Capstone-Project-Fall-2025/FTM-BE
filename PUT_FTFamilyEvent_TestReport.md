# Test Report: PUT /api/ftfamilyevent/{id}

## Function Information

| Field | Value |
|-------|-------|
| Function Code | UpdateEvent |
| Function Name | Update Family Tree Event |
| Created By | BuuLD |
| Executed By | BuuLD |
| Lines of Code | 14 |
| Lack of Test Cases | - |
...
| Condition | UTCID01 | UTCID02 | UTCID03 | UTCID04 |
|-----------|---------|---------|---------|---------|
| id is valid GUID | O | O | O | O |
| Request data is valid | O | - | O | O |
| Request data is invalid | - | - | - | - |
| Event exists in system | O | - | O | O |
| Event does not exist in system | - | O | - | - |
| RecurrenceType is valid (0-3) | O | - | - | O |
| RecurrenceType is invalid | - | - | O | - |
| StartTime is before EndTime | O | - | - | - |
...
| Condition | UTCID01 | UTCID02 | UTCID03 | UTCID04 |
|-----------|---------|---------|---------|---------|
| Service.UpdateEventAsync() executes successfully | O | - | - | - |
| Service.UpdateEventAsync() throws Exception (Event not found) | - | O | - | - |
| Service.UpdateEventAsync() throws Exception (Invalid recurrence type) | - | - | O | - |
| Service.UpdateEventAsync() throws Exception (Invalid time range) | - | - | - | O |
