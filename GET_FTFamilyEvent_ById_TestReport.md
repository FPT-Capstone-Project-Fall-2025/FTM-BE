# Test Report: GET /api/ftfamilyevent/event/{id}

## Function Information

| Field | Value |
|-------|-------|
| Function Code | GetEventById |
| Function Name | Get Family Tree Event by ID |
| Created By | BuuLD |
| Executed By | BuuLD |
| Lines of Code | 16 |
| Lack of Test Cases | - |
...
| Condition | UTCID01 | UTCID02 | UTCID03 |
|-----------|---------|---------|---------|
| Service.GetEventByIdAsync() returns event | O | - | - |
| Service.GetEventByIdAsync() returns null | - | O | - |
| Service.GetEventByIdAsync() throws Exception | - | - | O |
...
| StatusCode: 404 | - | O | - |
| StatusCode: 400 | - | - | O |
| Returns ApiSuccess with event data | O | - | - |
...
| Condition | UTCID01 | UTCID02 | UTCID03 |
|-----------|---------|---------|---------|
| Event retrieved successfully | O | - | - |
| Event not found | - | O | - |
