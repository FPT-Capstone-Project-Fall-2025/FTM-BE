# Test Report: GET /api/ftfamilyevent/by-member/{memberId}

## Function Information

| Field | Value |
|-------|-------|
| Function Code | GetEventsByMember |
| Function Name | Get Events by Member ID |
| Created By | BuuLD |
| Executed By | BuuLD |
| Lines of Code | 15 |
| Lack of Test Cases | - |
...
| Condition | UTCID01 | UTCID02 | UTCID03 | UTCID04 |
|-----------|---------|---------|---------|---------|
| memberId is valid GUID | O | O | O | O |
| PageIndex is provided | O | O | O | O |
| PageSize is provided | O | O | O | O |
| PageSize = 10 | O | O | O | - |
| PageSize = 100 | - | - | - | O |
| Events exist for member | O | - | - | O |
| No events exist for member | - | O | - | - |

### Service

| Condition | UTCID01 | UTCID02 | UTCID03 | UTCID04 |
|-----------|---------|---------|---------|---------|
| Service.GetEventsByMemberIdAsync() returns events | O | - | - | O |
| Service.GetEventsByMemberIdAsync() returns empty list | - | O | - | - |
| Service.GetEventsByMemberIdAsync() throws Exception | - | - | O | - |
