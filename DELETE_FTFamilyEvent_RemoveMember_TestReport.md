# Test Report: DELETE /api/ftfamilyevent/{eventId}/remove-member/{memberId}

## Function Information

| Field | Value |
|-------|-------|
| Function Code | RemoveMemberFromEvent |
| Function Name | Remove Member from Event |
| Created By | BuuLD |
| Executed By | BuuLD |
| Lines of Code | 15 |
| Lack of Test Cases | - |
...
| Condition | UTCID01 | UTCID02 | UTCID03 |
|-----------|---------|---------|---------|
| Service.RemoveMemberFromEventAsync() executes successfully | O | - | - |
...
| Returns true | O | - | - |
| Error message: "Member not found in event" | - | O | - |
...
| Service Exception | - | - | O |
| Server error | - | - | O |
| Member not found in event | - | O | - |

### Log Message

| Condition | UTCID01 | UTCID02 | UTCID03 |
|-----------|---------|---------|---------|
| Member removed from event successfully | O | - | - |
| Member not found in event | - | O | - |
| Exception message | - | - | O |
