# Test Report: GET /api/ftmember/{ftid}/get-by-userid

## Function Information

| Field | Value |
|-------|-------|
| Function Code | GetDetailedMemberOfFamilyTreeByUserId |
| Function Name | Get Detailed Member of Family Tree by UserId |
| Created By | BuuLD |
| Executed By | BuuLD |
| Lines of Code | 5 |
| Lack of Test Cases | - |
...
| userId is valid GUID | O | O |
| userId exists in system | O | - |
| userId does not exist in system | - | O |
| Member with userId exists in family tree | O | - |
| Member with userId does not exist in family tree | - | O |

### Service

| Condition | UTCID01 | UTCID02 |
|-----------|---------|---------|
| Service.GetByUserId() executes successfully | O | - |
| Service.GetByUserId() throws ArgumentException (Member not found) | - | O |
