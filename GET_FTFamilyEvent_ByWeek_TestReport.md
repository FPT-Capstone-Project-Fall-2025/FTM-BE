# Test Report: GET /api/ftfamilyevent/{year}/{month}/{week}

## Function Information

| Field | Value |
|-------|-------|
| Function Code | GetEventsGroupedByWeek |
| Function Name | Get Events Grouped by Week |
| Created By | BuuLD |
| Executed By | BuuLD |
| Lines of Code | 15 |
| Lack of Test Cases | - |
...
| Week is provided | O | O | O |
| FTId is provided | O | O | O |
| Year is valid (2024) | O | - | O |
| Month is valid (1-12) | O | - | O |
| Week is valid (1-4) | O | - | O |
| FTId is valid GUID | O | O | O |
| Events exist for week | O | - | - |
| No events exist for week | - | O | - |

### Service

| Condition | UTCID01 | UTCID02 | UTCID03 |
|-----------|---------|---------|---------|
| Service.GetEventsGroupedByWeekAsync() executes successfully | O | O | - |
...
| Condition | UTCID01 | UTCID02 | UTCID03 |
|-----------|---------|---------|---------|
| Events in week successfully | O | O | - |
| Exception message | - | - | O |
