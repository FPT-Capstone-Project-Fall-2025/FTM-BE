# Test Report: GET /api/donations/pending

## Function Information

| Field | Value |
|-------|-------|
| Function Code | GetPendingDonations |
| Function Name | Get Pending Donations |
| Created By | BuuLD |
| Executed By | BuuLD |
| Lines of Code | 37 |
| Lack of Test Cases | - |
...
| Pending donations exist | O | - | - |
| No pending donations exist | - | O | - |

### Service

| Condition | UTCID01 | UTCID02 | UTCID03 |
|-----------|---------|---------|---------|
| Service.GetPendingDonationsAsync() returns donations | O | - | - |
| Service.GetPendingDonationsAsync() returns empty list | - | O | - |
| Service.GetPendingDonationsAsync() throws Exception | - | - | O |
...
| Donations list contains data | O | - | - |
| Donations list is empty | - | O | - |
...
| Condition | UTCID01 | UTCID02 | UTCID03 |
|-----------|---------|---------|---------|
| Pending donations retrieved successfully | O | O | - |
| Error getting pending donations | - | - | O |
| Server error | - | - | O |
