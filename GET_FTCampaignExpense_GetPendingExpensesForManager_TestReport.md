# Test Report: GET /api/ftcampaignexpense/pending/manager/{managerId}

## Function Information

| Field | Value |
|-------|-------|
| Function Code | GetPendingExpensesForManager |
| Function Name | Get Pending Expenses For Manager |
| Created By | BuuLD |
| Executed By | BuuLD |
| Lines of Code | 10 |
| Lack of Test Cases | - |
...
| Condition | UTCID01 | UTCID02 | UTCID03 |
|-----------|---------|---------|---------|
| ExpenseService.GetPendingExpensesForManagerAsync() returns paginated expenses | O | - | - |
| ExpenseService.GetPendingExpensesForManagerAsync() returns empty list | - | O | - |
| ExpenseService.GetPendingExpensesForManagerAsync() throws Exception | - | - | O |
...
| Condition | UTCID01 | UTCID02 | UTCID03 |
|-----------|---------|---------|---------|
| Retrieved pending expenses for manager {ManagerId} successfully | O | O | - |
| No pending expenses found for manager {ManagerId} | - | O | - |
| Error retrieving pending expenses for manager {ManagerId} | - | - | O |
| Server error | - | - | O |
